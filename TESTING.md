...
- [Manual Testing](#manual-testing)
  - [EPIC 1: Viewing & Navigation](#epic-1-viewing--navigation)
    - [1.1 Global Navigation](#11-global-navigation)
    - [1.2 Product Pages](#12-product-pages)
  - [EPIC 2: User Account](#epic-2-user-account)
    - [2.1 Authentication](#21-authentication)
    - [2.2 Profile Management](#22-profile-management)
  - [EPIC 3: Purchasing](#epic-3-purchasing)
    - [3.1 Shopping Bag](#31-shopping-bag)
...
- [User Story Testing](#user-story-testing)
  ...
  - [EPIC: Purchasing & Checkout](#3-epic-purchasing--checkout)
- [Product Listing & Detail Pages Test Cases](#1-product-listing--detail-pages-test-cases)
- [Shopping Bag Test Cases](#2-shopping-bag-test-cases)
- [Checkout Process Test Cases](#3-checkout-process-test-cases)
...
| **To Do** | **In Progress** | **Done** |  
|-----------|----------------|----------|  
| - Add social auth (Facebook) | - Test password reset flow | ✅ User registration/signup |  
